...
public class ArtuzLooping
{
    ...
    while(processor1 < 1 || processor1 > 10)  {
    ...
    while(motherboard1 < 1 || motherboard1 > 10)  {
        System.out.println("Please Pick Again!");
    motherboard1 = input.nextInt();
    }
